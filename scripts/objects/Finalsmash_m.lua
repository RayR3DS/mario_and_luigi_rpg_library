...
function SnowGraveSpell:init(user)
    ...
    self.bg = Assets.getTexture("effects/finalsmash/mario/gradient")

    self.bg_snowfall = Assets.getTexture("effects/finalsmash/mario/snowfall_1")
    ...
    Assets.playSound("finalsmash_m", 0.5)
