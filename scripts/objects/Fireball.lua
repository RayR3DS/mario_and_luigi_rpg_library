...
function RudeBusterBeam:init(red, x, y, tx, ty, after)
    super.init(self, red and "effects/fireball/fireball" or "effects/fireball/fireball", x, y)
...
function RudeBusterBeam:update()
    ...
    if self.afterimg_timer >= 1 then
        ...
        local sprite = Sprite(self.red and "effects/fireball/fireball" or "effects/fireball/fireball", self.x, self.y)
